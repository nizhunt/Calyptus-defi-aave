...
/**
 * @title CalyptusDefiAAVE2
 * @dev This smart contract interacts with AAVE protocol v2.
 * @dev It is created as a clone from the CalyptusDefiAAVE2Factory.
 */
contract CalyptusDefiAAVE2 is Ownable, Initializable {
    ...
    /**
     * @dev As CalyptusDefiAAVE2 is used as a Clone, there is no constructor.
