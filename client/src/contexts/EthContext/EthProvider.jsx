            ...
            try {
                ...
                for (const [contractName, artifact] of Object.entries(
                    ...
                    if (contractName === "IProtocolDataProviderAAVE2") {
                        address =
                            process.env
                                .REACT_APP_PROTOCOL_DATA_PROVIDER_AAVE2_CONTRACT_ADDRESS;
                    } else {
                        wrongNetworkId =
                            artifact.networks[networkID] === undefined;
                    }
                    if (!wrongNetworkId) {
                ...
                if (contracts["HelloDefiAAVE2Factory"]) {
                    const cloneAddress =
                        await contracts.HelloDefiAAVE2Factory.methods
                            .userContracts(accounts[0])
                            .call({ from: accounts[0] });
                    if (cloneAddress !== ZERO_ADDRESS) {
                        contracts.HelloDefiAAVE2 = new web3.eth.Contract(
                            artifacts.HelloDefiAAVE2.abi,
                            cloneAddress
                        );
                    }
                }
